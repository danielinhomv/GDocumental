        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label>Cliente</label>
                    <select name="cliente_id" id="cliente_id" class="form-control select2 select2-hidden-accessible"
                ...
                <input id="nota_adicional" name="nota_adicional" class="form-control input-sm" type="text"
                    placeholder="nota">
            </div>
